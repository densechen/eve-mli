...
from eve.app.exp_manager import ExperimentManager, StoreDict
from eve.app.utils import set_random_seed
...
args.env_kwargs = dict(
    ...
    pretrained="/media/densechen/data/code/eve-mli/examples/checkpoint/eve-cifar10-vggsmall-zxd-93.4-8943fa3.pth",
    device="auto",
    eval_steps=100,
)
