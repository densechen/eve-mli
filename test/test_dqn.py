...
action_space = space.EveDiscrete(n=8,
                                 max_neurons=mnist_classifier.max_neurons,
                                 max_states=mnist_classifier.max_states)

mnist_classifier.set_action_space(action_space)
