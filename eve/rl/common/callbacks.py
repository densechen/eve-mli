...
from eve.rl.common import base_class, logger  # pytype: disable=pyi-error
from eve.rl.common.evaluation import evaluate_policy
from eve.rl.common.vec_env import DummyVecEnv, VecEnv, sync_envs_normalization
...
class StopTrainingOnMaxEpisodes(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        done_array = np.array(
            self.locals.get("done") if self.locals.
            get("done") is not None else self.locals.get("dones"))
