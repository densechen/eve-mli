...
import gym
import numpy as np
from eve.rl.common.vec_env.base_vec_env import (VecEnv, VecEnvIndices,
                                                VecEnvObs, VecEnvStepReturn)
from eve.rl.common.vec_env.util import (copy_obs_dict, dict_to_obs,
                                        obs_space_info)
...
class DummyVecEnv(VecEnv):
    ...
    def env_is_wrapped(self,
        ...
        from eve.rl.common import env_util
