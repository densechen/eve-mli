...
from eve.rl.common.buffers import ReplayBuffer
from eve.rl.common.type_aliases import ReplayBufferSamples, RolloutBufferSamples
from eve.rl.common.vec_env import VecNormalize
from eve.rl.common.vec_env.obs_dict_wrapper import ObsDictWrapper
from eve.rl.her.goal_selection_strategy import GoalSelectionStrategy
...
class HerReplayBuffer(ReplayBuffer):
    ...
    def __init__(
        ...
        super(HerReplayBuffer, self).__init__(buffer_size, observation_space,
    ...
    def sample_offline(
        ...
        return self._sample_transitions(batch_size=None,
                                        maybe_vec_env=None,
    ...
    def add(
        ...
        self.buffer["observation"][self.pos][
            self.current_idx] = obs["observation"]
        self.buffer["achieved_goal"][self.pos][
            self.current_idx] = obs["achieved_goal"]
        self.buffer["desired_goal"][self.pos][
            self.current_idx] = obs["desired_goal"]
        ...
        self.buffer["next_obs"][self.pos][
            self.current_idx] = next_obs["observation"]
        self.buffer["next_achieved_goal"][self.pos][
            self.current_idx] = next_obs["achieved_goal"]
        self.buffer["next_desired_goal"][self.pos][
            self.current_idx] = next_obs["desired_goal"]
