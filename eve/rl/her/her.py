...
from eve.rl.common.noise import ActionNoise
from eve.rl.common.off_policy_algorithm import OffPolicyAlgorithm
from eve.rl.common.policies import BasePolicy
from eve.rl.common.save_util import load_from_zip_file, recursive_setattr
from eve.rl.common.type_aliases import GymEnv, MaybeCallback, RolloutReturn
from eve.rl.common.utils import check_for_correct_spaces
from eve.rl.common.vec_env import VecEnv
from eve.rl.common.vec_env.obs_dict_wrapper import ObsDictWrapper
from eve.rl.her.goal_selection_strategy import KEY_TO_GOAL_STRATEGY, GoalSelectionStrategy
from eve.rl.her.her_replay_buffer import HerReplayBuffer
...
class HER(BaseAlgorithm):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(HER, self).__init__(policy=BasePolicy,
                                  env=env,
    ...
    def _sample_her_transitions(self) -> None:
        ...
        self.replay_buffer.extend(observations, next_observations, actions,
                                  rewards, dones)
        ...
        if self.online_sampling:
            ...
            if truncate_last_trajectory and current_idx > 0:
                ...
                self.replay_buffer.pos = (
                    self.replay_buffer.pos +
                    1) % self.replay_buffer.max_episode_stored
