...
from eve.app.policies import (BaseFeaturesExtractor, BasePolicy,
                              ContinuousCritic, FlattenExtractor,
...
class SAC(OffPolicyAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        if isinstance(self.ent_coef, str) and self.ent_coef.startswith("auto"):
            ...
            # is passed
            self.ent_coef_tensor = th.tensor(float(self.ent_coef)).to(  # pylint: disable=not-callable
                self.device)
            ...
            for replay_data in replay_datas:
                ...
                with th.no_grad():
                    ...
                    next_q_values, _ = th.min(next_q_values,
                                              ...
                                              keepdim=True)
                    # add entropy term
                    next_q_values = next_q_values - ent_coef * next_log_prob.unsqueeze(
                        dim=-1)
